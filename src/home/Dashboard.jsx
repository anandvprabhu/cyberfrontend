...
class News extends React.Component {
    ...
    async componentDidMount() {
      ...
      let res = await fetch(
        `https://newsapi.org/v2/everything?q=tesla&from=2023-03-24&sortBy=publishedAt&apiKey=441cee269ba9433fae71d6420cc01c1b`
      );
...
export default News;
// 441cee269ba9433fae71d6420cc01c1b
// const API = 'https://newsapi.org/v2/everything?q=tesla&from=2023-03-24&sortBy=publishedAt&apiKey=441cee269ba9433fae71d6420cc01c1b';